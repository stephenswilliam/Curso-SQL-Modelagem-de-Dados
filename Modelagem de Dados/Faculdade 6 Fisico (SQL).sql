...
SELECT CONCAT(A.Nome_Aluno, ' ', A.Sobrenome_Aluno) AS Aluno, A.CPF, T.Num_Telefone, TT.Tipo_Telefone, CONCAT(TL.Tipo_Logradouro, ' ', E.Nome_Rua, ', ', E.Num_Rua) AS Logradouro, E.Complemento, E.CEP
FROM Aluno A
INNER JOIN Telefones_Aluno T
ON A.RA = T.RA
inner join tipo_telefone as TT
on T.Cod_Tipo_Telefone = TT.Cod_Tipo_Telefone
...
select D.Nome_Disciplina, C.Nome_Curso, concat(P.Nome_Professor, ' ', P.Sobrenome_Professor) as Docente, Dep.Nome_departamento
from disciplina as D
inner join curso_disciplina as CD
on D.Cod_Disciplina = CD.Cod_Disciplina
inner join curso as C
on CD.Cod_Curso = C.Cod_Curso
inner join prof_disciplina as PD
on d.Cod_Disciplina = PD.Cod_Disciplina
inner join professor as P
on PD.Cod_Professor = P.Cod_Professor
inner join departamento as Dep
on C.Cod_Departamento = Dep.Cod_Departamento
order by D.Nome_Disciplina;
